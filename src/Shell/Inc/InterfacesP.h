...
IRegTreeOptions : IUnknown
{
    ...
    STDMETHOD(InitTree)(HWND, HKEY, const CHAR*, const CHAR*) PURE;
    STDMETHOD(WalkTree)(unsigned int) PURE;
    STDMETHOD(ToggleItem)(HTREEITEM) PURE;
    STDMETHOD(ShowHelp)(HTREEITEM, ULONG) PURE;
...
{
	virtual HRESULT STDMETHODCALLTYPE AddNameSpace(const GUID*, IShellFolder*, PCIDLIST_ABSOLUTE, DWORD, UINT) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetNameSpaceID(PCUITEMID_CHILD, GUID*) = 0;
	virtual HRESULT STDMETHODCALLTYPE QueryNameSpace(DWORD, GUID*, IShellFolder**) = 0;
	virtual HRESULT STDMETHODCALLTYPE EnumNameSpace(DWORD, DWORD*) = 0;
	virtual HRESULT STDMETHODCALLTYPE UnWrapIDList(
		PCUITEMID_CHILD, LONG, IShellFolder**, PIDLIST_ABSOLUTE*, ITEMID_CHILD**, LONG*) = 0;
	virtual HRESULT STDMETHODCALLTYPE QueryNameSpace2(DWORD, QUERYNAMESPACEINFO*) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetNameSpaceGroupID(PCUITEMID_CHILD, UINT*) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetFlagsForChild(PCUITEMID_CHILD, const GUID&, DWORD*) = 0;
};
...
MIDL_INTERFACE("8d79a7d3-6397-48ee-bc1f-1f021f8fff1c")
ICatBandManager : IUnknown
{
	virtual HRESULT STDMETHODCALLTYPE EnumNextCatBand(REFCATID, CLSID*, int*, WCHAR*, UINT*, DWORD*, BOOL*) = 0;
	virtual HRESULT STDMETHODCALLTYPE EnumReset(REFCATID) = 0;
	virtual HRESULT STDMETHODCALLTYPE ToggleCatBand(REFCATID, REFCLSID, const int) = 0;
	virtual HRESULT STDMETHODCALLTYPE ShowCatBand(REFCATID, REFCLSID, const int) = 0;
	virtual HRESULT STDMETHODCALLTYPE HideCatBand(REFCATID, REFCLSID, const int) = 0;
	virtual HRESULT STDMETHODCALLTYPE QueryCatBand(REFCATID, REFCLSID, const int, WCHAR*, const UINT, DWORD*, BOOL*) = 0;
	virtual HRESULT STDMETHODCALLTYPE RefreshCatBandCache(REFCATID) = 0;
};

extern "C" inline const IID IID_ICatBandManager = __uuidof(ICatBandManager);
