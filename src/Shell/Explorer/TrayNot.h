...
public:
    ...
    LRESULT TrayNotifyInfo(HWND hwndTray, HWND hwndFrom, PCOPYDATASTRUCT pcds); // @MOD: Fix certain applications unable to find taskbar position
...
protected:
   ...
   // InfoTip/Balloon tip functions
    ...
    LRESULT _TrayNotifyInfo(PTRAYNOTIFYINFO pnii); // @MOD: Fix certain applications unable to find taskbar position
