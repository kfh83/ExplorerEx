...
public:
	...
	STDMETHODIMP ItemPrePaint(
		HDC hdc, RECT* prc, NSTCCUSTOMDRAW* pnstccdItem, COLORREF* pclrText, COLORREF* pclrTextBk, LRESULT* plres);
	STDMETHODIMP ItemPostPaint(HDC hdc, RECT* prc, NSTCCUSTOMDRAW* pnstccdItem);

	// *** INameSpaceTreeControlDropHandler ***
	STDMETHODIMP OnDragEnter(
		IShellItem* psiOver, IShellItemArray* psiaData, BOOL fOutsideSource, DWORD grfKeyState, DWORD* pdwEffect);
	...
	STDMETHODIMP OnDrop(
		IShellItem* psiOver, IShellItemArray* psiaData, int iPosition, DWORD grfKeyState, DWORD* pdwEffect);
